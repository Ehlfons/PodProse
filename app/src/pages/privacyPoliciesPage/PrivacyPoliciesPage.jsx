  ...
  return (
    <Fragment>
      <main className="terms-page">
        <h1>
          <h1>POLÍTICA DE PRIVACIDAD - PodProse</h1>
        </h1>
        <p>
          El presente Política de Privacidad establece los términos en que
          PodProse usa y protege la información que es proporcionada por sus
        ...
        <p>
          PodProse está altamente comprometido para cumplir con el compromiso de
        ...
        <p>
          ...
          respecto al tráfico web, y también facilita las futuras noticias
          recurrentes. Otra función que tienen las cookies es que con ellas las
        ...
        <p>
          PodProse Se reserva el derecho de cambiar los términos de la presente
